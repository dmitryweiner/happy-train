...
// Допустимый размер поля уровня (GRID_WIDTH×GRID_HEIGHT — размер по умолчанию в редакторе)
export const FIELD_MIN_SIZE = 3;
export const FIELD_MAX_WIDTH = 30;
export const FIELD_MAX_HEIGHT = 20;
